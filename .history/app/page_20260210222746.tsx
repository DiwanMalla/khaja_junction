...
// Configuration
const WA_NUMBER = "61405452688"; // Updated with number found online
const LOCATION_URL = "https://maps.app.goo.gl/YourMapLinkHere"; // Placeholder if not found exact generic link
