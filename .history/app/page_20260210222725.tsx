  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-stone-900 pb-32">
      ...
      >
        <div className="max-w-4xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div className={`transition-all duration-300 ${scrolled ? 'w-10 h-10' : 'w-12 h-12'} overflow-hidden rounded-full border-2 border-white shadow-md`}>
              <img src="/logo.jpeg" alt="DB Dai Logo" className="w-full h-full object-cover" />
            </div>
            <div className={`font-bold transition-all duration-300 hidden sm:block ${scrolled ? 'text-red-700 text-lg' : 'text-white text-xl drop-shadow-md'}`}>
      ...
      <section className="relative h-[60vh] md:h-[500px] flex items-center justify-center bg-stone-900 overflow-hidden">
        ...
        <div className="absolute inset-0 bg-[url('/bg-hero.png')] bg-cover bg-center mix-blend-overlay opacity-60"></div>
        
        <div className="relative z-10 text-center px-4 max-w-2xl mx-auto animate-fade-in-up flex flex-col items-center">
           <div className="w-24 h-24 md:w-32 md:h-32 rounded-full border-4 border-white/20 shadow-xl overflow-hidden mb-6 block sm:hidden">
              <img src="/logo.jpeg" alt="DB Dai Logo" className="w-full h-full object-cover" />
           </div>
