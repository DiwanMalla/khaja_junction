      ...
      >
        <div className="max-w-4xl mx-auto px-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            <div
              className={`transition-all duration-300 ${scrolled ? "w-10 h-10" : "w-12 h-12"} overflow-hidden rounded-full border-2 border-white shadow-md`}
            >
              <img
                src="/logo.jpeg"
                alt="DB Dai Logo"
            ...
            <div
              className={`font-bold transition-all duration-300 hidden sm:block ${scrolled ? "text-red-700 text-lg" : "text-white text-xl drop-shadow-md"}`}
            >
